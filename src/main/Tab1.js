function submit() {
    ...
    var weight3 = 0;
    var weight4 = 0;
    var g1 = parseFloat(document.getElementById("grade1").value);
    if (g1 >= 0 && g1 <= 100)
        grade1 = g1;
    var g2 = parseFloat(document.getElementById("grade2").value);
    if (g2 >= 0 && g2 <= 100)
        grade2 = g2;
    var g3 = parseFloat(document.getElementById("grade3").value);
    if (g3 >= 0 && g3 <= 100)
        grade3 = g3;
    var g4 = parseFloat(document.getElementById("grade4").value);
    if (g4 >= 0 && g4 <= 100)
        grade4 = g4;
    ...
    if (w3 >= 0 && w3 <= 100)
        weight3 = w3;
    var w4 = parseFloat(document.getElementById("weight4").value);
    if (w4 >= 0 && w4 <= 100)
        weight4 = w4;
